...
| 🏷️ 900+ 标签库 | 角色基础 / **性质（攻受性 1/0）** / 体型身体 / 服装脱衣 / 动作体位 / 表情状态 / 场景环境 / 道具细节 / **审查与码（步兵/骑兵）** / **发型 / 发色 / 视角镜头** / 质量词 分类 |
| 🎌 动漫角色库 | **日本动漫（163 部 / 553 角色）与国产动漫（73 部 / 641 角色）分开存放**，经典+热门+冷门全覆盖；**男角色进男同区、女角色进女同区**，一键搜作品/角色、随机角色 |
...
- **覆盖范围**：从 1970 年代经典（高达、龙珠、美少女战士）到 2024-2026 新番（胆大党、怪兽8号、芙莉莲 S2 等），含 BL（世界第一初恋、GIVEN）与百合（柑橘味香气、终将成为你）题材，国漫含魔道祖师、天官赐福、斗罗大陆、时光代理人等；**国产手游《碧蓝航线》全阵营收录**（白鹰/皇家/重樱/铁血/东煌/北方联合/鸢尾/撒丁/META/塞壬等 11 组、共 498 名角色：496 名舰娘 + 男角色指挥官/奥斯塔，danbooru 标签统一带 `(azur_lane)` 后缀）
...
「🧭 性质（攻受性 1/0）」分类男同区/女同区都有（29 个标签）：

- **基础定位**：`seme`（攻）×1.1、`uke`（受）×1.1、`switch`（互攻）、`top`/`bottom`、`versatile`（全能）、`dominant`（支配系）、`submissive`（顺从系）
- **攻系风格**：强攻、温柔攻、冷面攻、抖S攻、病娇攻、傲娇攻
- **受系风格**：强受、害羞受、傲娇受、病娇受、抖M受、泪眼汪汪的受
- **女同 T/P**：`tomboy`（T 系）、`butch`（铁T）、`femme`（P 系）、`soft butch`（软T）

> 随机生成约 55% 概率自动带一个核心攻受标签（seme/uke/switch/dominant/submissive）。
